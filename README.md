# CS416 Data Visualization: Narrative Visualization Project
Authored by Johnny Svigelj (svigelj3)
for the University of Illinois at Urbana-Champaign MCS Program.
The contents of this repository are for educational purposes only.

## Overview

This repository contains the code for an interactive visualization regarding pitching trends in Major League Baseball (MLB). The datasets include standard pitching and statcast statistics since 2008 (when Statcast began to publish veolicty statistics), as well as a record of pitchers associated with Major League teams and farm systems who have undergone UCL Reconstruction ("Tommy John" or TJ) surgeries. See the Sources section for direct links.

The visualizations are concerned with the changing landscape of pitching in MLB. As the game grows and evolves, pitching strategies change. We can see statistical patterns arise as teams look towards higher velocity and lower inning counts. 


## Sources

The following sources were used for the data included in this repository:
